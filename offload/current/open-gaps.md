...
- the merged session workspace is a meaningful step, but the Operate page still needs stronger chat-like rhythm and richer live interaction to feel fully human-usable
- the new message-style session lane now supports draft reuse, append, and prompt restoration from cards, but it still needs richer in-lane interaction than composer-shaping controls alone
