...
- the structured proof panel is a better proof surface, and the new `Environment Notes` lane calms recurring warning noise, but the inspector lane still needs to feel more like a polished product panel and less like stacked diagnostics
- warning/proof hygiene is better, but the operator still needs a final cleaner strategy for surfacing Codex-local warnings without making the product feel noisy or brittle
